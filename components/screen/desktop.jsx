...
import KdePanel from './kde_panel';
import apps from '../../apps.config';
import Window from '../base/window';
import ArchApp from '../base/arch_app';
        ...
        if (new_folders === null && new_folders !== undefined) {
            ...
            new_folders.forEach(folder => {
                apps.push({
                    ...
                    title: folder.name,
                    icon: '/themes/Yaru/system/arch_folder.svg',
                    disabled: true,
                    favourite: false,
    ...
    render() {
        return (
            <div className={" h-full w-full flex flex-col items-end justify-start content-start flex-wrap-reverse pt-8 bg-transparent relative overflow-hidden overscroll-none window-parent"}>
                ...
                {/* Desktop Environment Panel / Sidebar */}
                {this.props.desktopEnvironment === "gnome" ? (
                    <SideBar apps={apps}
