...
export class ArchApp extends Component {
        ...
        return (
            ...
            >
                <div className="relative">
                    <img width="40px" height="40px" className="mb-1 w-10" src={this.props.icon} alt={"Arch " + this.props.name} />
